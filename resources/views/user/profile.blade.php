...
@section('title','Viettel - Thông tin tài khoản')
@section('content')
            ...
            <form action="{{ route('user.profile') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="text-center">
                        <img style="    border: 4px solid #979993; border-radius: 50%; margin: auto; background-size: cover ;  width: 180px; height: 180px;   background-image: url({{ auth()->user()->image ? env('APP_URL') . '/storage/app/' . auth()->user()->image : asset('storage/placeholders/user_placeholder.jpg') }})" alt="">
                        <div class="mb-3">
        ...
        <div class="container">
            <div class="row">
                <div class="cold-md-8 offset-md-2 text-center">
                    ...
                    <a href="{{ route('frontend.home') }}" class="btn btn-primary">Quay lại trang chủ</a>
                </div>
            </div>
        </div>
    </div>
