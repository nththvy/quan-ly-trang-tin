        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><a href="{{route('admin.tags.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Thêm từ khóa mới</a></div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('admin.tags.update', $tag)}}"><i class='bx bxs-edit'></i></a>
                                        <a href="{{ route('admin.tags.delete', ['id' => $tag->id]) }}"
                                            onclick="return confirm('Bạn có muốn xóa từ khóa {{ $tag->name }} không?')"
                                            class="ms-3">
