                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $category->slug }}</td>
                                <td>
                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.categories', $category) }}">Chi tiết bài viết</a>
                                </td>
                                <td>{{ $category->created_at->format('d/m/Y') }}</td>

                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="{{ route('admin.categories.update', $category)}}"><i class='bx bxs-edit'></i></a>
                                        <a href="{{ route('admin.categories.delete', ['id' => $category->id]) }}"
                                            onclick="return confirm('Bạn có muốn xóa từ khóa {{ $category->name }} không?')"
                                            class="ms-3">
