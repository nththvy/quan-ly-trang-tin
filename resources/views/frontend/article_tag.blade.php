...
@section('title', $tag->name . ' - Viettel')
...
<div class="main--breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><span>{{ $tag->name }}</span></li>
        </ul>
    </div>
</div>
<!-- Main Breadcrumb End -->
                    ...
                    <div class="post--item post--single post--title-largest pd--30-0">
                        ...
                        <div class="block-21 d-flex animate-box post">
                            ...
                            <div class="text">
                                ...
                                <div class="meta">
                                    <div>
                                        <a class="date" href="#"><span class="icon-calendar"></span>{{ $article->created_at->locale('vi')->diffForHumans() }}</a>
                                    </div>
                                    <div>
                        ...
                        @empty
                        <p class="lead">Không có bài viết nào có thẻ này.</p>
                        @endforelse
